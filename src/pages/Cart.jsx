            ...
            {cartitems.length ? (
                <div className="_9zeg">
                    <div className="depot-cob">
                                ...
                                {cartitems.map((item, index) => {
                                    return (
                                        <div key={index} className="item">
                                            <span className="specter-doer">Delivery by Tue Aug 15</span>
                                            ...
                                            <div className="foulards-ids">
                                                ...
                                                <div style={{ display: "flex", flexDirection: "column", color: "grey", fontSize: "14px" }}>
                                                    <span>8 GB RAM</span>
                                                    <span style={{ display: "inline-block", marginTop: "5px" }}>Seller: Retail Net</span>
                                                </div>
                                                <div className="price-discount">
                                                    <span style={{ fontSize: "14px", color: "grey", textDecoration: "line-through", alignSelf: "end" }}>₹ {item.price}</span>
                                                    <span style={{ fontWeight: "600", color: "rgb(27, 27, 27)" }}>₹ {(item.price - (item.price * item.discountPercentage * 0.01)).toFixed(2)}</span>
                                                    <span style={{ fontSize: "14px", color: "green", fontWeight: "600" }}>{item.discountPercentage} % Off</span>
                                                </div>
                        ...
                        <div className="price">
                            <div style={{ color: "grey", padding: "15px 20px", fontWeight: "600", borderBottom: "1px solid rgb(228, 228, 228)" }}>
                                PRICE DETAILS
                            </div>
